      ...
      success: function (res) {
        ...
        if (gallery.length > 0) {
          ...
          gallery.forEach((el) => {
            str +=
              `
                <div class="owl-item pointer"><img class="imgChange" src="` +
              el +
              `" alt=""></div>
                `;
          ...
          dtproduct.forEach((el) => {
            str =
              ...
              el.images +
              `" alt="" style="width: 100%;" id="changeimg-product">`;
            ...
            str =
              ...
              ` %</td>                  
                ...
                <div class="row justify-content-between">
                    <button class="btn btn-danger col m-2 buynowBtn" detail-id="` +
              el.id +
              `">Mua ngay</button> 
                     
                    <button class="btn btn-success col col-md m-2 w-auto addtocartBtn" cart-id="` +
              el.id +
              ...
              el.id +
              `" class="btn btn-primary col col-md m-2 w-100 chitietBtn" item-id="` +
              el.id +
              `">Chi tiết</a> 
                </div>        
